...
export default function SiteAuditWorkspace() {
  ...
  function clearAudit() {
    ...
    setSiteGeometry(null); setDetectedBoundary(null); setSiteId(null); setSiteLocation(null); setContext(null); setFindingId(null);
    setMetrics({ perimeterMeters: null, areaSquareMeters: null });
  ...
  async function saveSite() {
    ...
    try {
      ...
      const result = await response.json();
      setSiteId(result.data.id); setStatus("Digital Site Twin created");
    ...
    <main className="audit-shell">
      ...
      <section className="audit-workspace">
        <aside className="side-panel left-panel">
          ...
          {siteId && <><EvidencePanel siteId={siteId} location={siteLocation} findingId={findingId} /><SecurityObjectPanel siteId={siteId} /><FindingPanel siteId={siteId} onCreated={(finding) => setFindingId(finding.id)} /><OpportunityPanel siteId={siteId} findingId={findingId} /></>}
        </aside>
